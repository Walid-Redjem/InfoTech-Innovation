          ...
          <div className="relative">
            ...
            <div className="space-y-8">
              {[
                ...
                { year: "2024", en: "A New Identity, A Bigger Vision", ar: "هوية جديدة، رؤية أوسع", descEn: "What started as 5 passionate students became 25 by year's end. We shed the old name and emerged as InfoTech Innovation — ready to move faster, think bigger, and impact deeper.", descAr: "ما بدأ بـ 5 طلاب متحمسين أصبح 25 عضواً بنهاية العام. تخلّينا عن الاسم القديم وانطلقنا بهوية InfoTech Innovation — أسرع، أطمح، وأعمق أثراً.", color: "#2EC4B6" },
                { year: "2025", en: "Opening Doors to the Real World", ar: "فتح أبواب العالم الحقيقي", descEn: "We took innovation beyond the classroom — organizing workshops and conventions with real enterprises. Our community surged past 70 active members, hungry to learn and ready to lead.", descAr: "نقلنا الابتكار خارج الفصول الدراسية — ورشات عمل وملتقيات مع مؤسسات حقيقية. تجاوز مجتمعنا 70 عضواً نشطاً، شغوفين بالتعلم ومستعدين للقيادة.", color: "#f97316" },
