        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="relative">
            ...
            <div className="space-y-8">
              {[
                { year: "2023", en: "It Started With an Idea", ar: "بدأ الأمر بفكرة", descEn: "A small group of people in Algeria asked a simple question: what if students, teachers, and local institutions could actually work together? That question became Learning Informatique.", descAr: "سألت مجموعة صغيرة في الجزائر سؤالاً بسيطاً: ماذا لو تمكّن الطلاب والمعلمون والمؤسسات من التعاون فعلاً؟ من ذلك السؤال وُلدت Learning Informatique.", color: "#9B6B9B" },
                { year: "2024", en: "Growing Pains & a New Name", ar: "النمو وتغيير الاسم", descEn: "We were 5 students figuring things out as we went. By the end of the year we were 25, and we knew we'd outgrown our name. InfoTech Innovation felt closer to what we were becoming.", descAr: "كنّا 5 طلاب نتعلّم ونجرّب. وبنهاية العام أصبحنا 25، وأدركنا أننا تجاوزنا اسمنا القديم. InfoTech Innovation بدا أقرب إلى ما صرنا عليه.", color: "#2EC4B6" },
                { year: "2025", en: "Meeting the Real World", ar: "لقاء العالم الحقيقي", descEn: "We started running workshops and sitting across the table from real companies. It was a bit intimidating at first, but our community grew to 70+ members and the conversations got serious.", descAr: "بدأنا نُنظّم ورشات عمل ونجلس أمام شركات حقيقية. كان الأمر مرهباً في البداية، لكن مجتمعنا نما ليتجاوز 70 عضواً وأصبحت النقاشات جادة.", color: "#f97316" },
                { year: "2026", en: "Now It's Official", ar: "أصبح رسمياً الآن", descEn: "InfoTech Innovation is officially recognized. We launched a full platform to track community issues and run surveys in real time. Honestly, we're proud of how far we've come.", descAr: "InfoTech Innovation باتت معترفاً بها رسمياً. أطلقنا منصة متكاملة لتتبع القضايا وإجراء استبيانات فورية. بصراحة، نفخر بما وصلنا إليه.", color: "#22c55e" },
              ].map((item, i) => (
                <AnimatedSection key={i} delay={i * 0.1}>
