        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="relative">
            ...
            <div className="space-y-8">
              {[
                { year: "2023", en: "Learning Informatique Founded", ar: "تأسيس Learning Informatique", descEn: "Learning Informatique was established in Algeria with a mission to connect youth, educators, and institutions.", descAr: "تأسست Learning Informatique في الجزائر بمهمة ربط الشباب والمعلمين والمؤسسات.", color: "#9B6B9B" },
                { year: "2024", en: "Renamed to InfoTech Innovation", ar: "إعادة التسمية إلى InfoTech Innovation", descEn: "Renamed from Learning Informatique to InfoTech Innovation. Started with just 5 students and grew to 25 members by end of 2024.", descAr: "تمت إعادة التسمية من Learning Informatique إلى InfoTech Innovation، بدأنا بـ 5 طلاب ووصلنا إلى 25 عضواً بنهاية 2024.", color: "#2EC4B6" },
                { year: "2025", en: "Workshops & Enterprise Conventions", ar: "ورشات عمل وتعاون مع المؤسسات", descEn: "Organized workshops and conventions with enterprises, expanding our community to over 70 active students.", descAr: "نظّمنا ورشات عمل وملتقيات مع المؤسسات، وتوسّع مجتمعنا ليضم أكثر من 70 طالباً نشطاً.", color: "#f97316" },
                { year: "2026", en: "Full Platform & Official Recognition", ar: "المنصة الكاملة والاعتراف الرسمي", descEn: "Launched the complete digital hub with real-time surveys, issue tracking, and analytics. InfoTech Innovation becomes officially recognized.", descAr: "إطلاق المنصة الرقمية الكاملة مع الاستبيانات الفورية وتتبع القضايا والتحليلات. InfoTech Innovation تصبح رسمية.", color: "#22c55e" },
              ].map((item, i) => (
                <AnimatedSection key={i} delay={i * 0.1}>
